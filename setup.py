...
setup(name='lsaBGC',
      ...
      license='BSD-3',
      packages=['lsaBGC'],
      scripts=['bin/lsaBGC-Process.py', 'bin/summarizeLsaBGCReporterResults.py', 'bin/lsaBG-See.py',
			   'bin/lsaBGC-Cluster.py', 'bin/lsaBGC-HomologReports.py', 'bin/lsaBGC-MetaNovelty.py',
