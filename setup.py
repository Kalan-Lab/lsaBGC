...
setup(name='lsaBGC',
      ...
      license='BSD-3',
      packages=['lsaBGC'],
      scripts=['workflows/lsaBGC-AutoProcess.py', 'workflows/lsaBGC-AutoAnalyze.py', 'workflows/lsaBGC-AutoExpansion.py', 'bin/lsaBGC-Cluster.py', 'bin/lsaBGC-See.py', 'bin/lsaBGC-PopGene.py', 'bin/lsaBGC-Refiner.py', 'bin/lsaBGC-Expansion.py', 'bin/lsaBGC-Divergence.py', 'bin/lsaBGC-DiscoVary.py'],
      zip_safe=False)
