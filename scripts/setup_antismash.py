...
def create_parser():
    ...
    parser.add_argument('-p', '--db_download_path', help='Path to where Pfam should be downloaded and setup.', required=False, default=lsaBGC_main_directory + 'db/')
...
def setup_annot_dbs():
    ...
    antismash_install_path = os.path.abspath(myargs.install_path) + '/'
